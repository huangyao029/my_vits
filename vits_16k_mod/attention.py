...
class Encoder(nn.Module):
    def __init__(self, hidden_channels, filter_channels, n_heads, n_layers, kernel_size = 1,
                 p_dropout = 0., window_size = 4, **kwargs):
        super().__init__()
...
class MultiHeadAttention(nn.Module):
    def __init__(self, channels, out_channels, n_heads, p_dropout = 0., window_size = None, 
    ...
    def attention(self, query, key, value, mask = None):
        ...
        if mask is not None:
            ...
            if self.block_length is not None:
                assert t_s == t_t, "Local attention is only avaiable for self-attention."
